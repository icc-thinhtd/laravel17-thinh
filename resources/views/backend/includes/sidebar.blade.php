<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{route('2nds')}}" class="brand-link">
        <img src="/images/logo.png" alt="2nds Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        <span class="brand-text font-weight-light">2nds</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="/images/avartar.png" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
            ...
            <form id="logout-form" action="{{ route('logout') }}" method="POST">
                @csrf
                <button type="submit" class="form-control btn text-info">Logout</button>
            </form>
