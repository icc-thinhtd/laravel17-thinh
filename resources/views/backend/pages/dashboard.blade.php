...
{{--                                <a href="{{route('backend.product.show',$product->id)}}">--}}
                                <tr>
                                    ...
                                    <td>
                                        @if($product->status == 0) <span class="tag text-warning">Hủy</span>
                                        @elseif($product->status == 1) <span class="tag text-success">Đã duyệt</span>
                                        @else <span class="tag text-danger">Chờ duyệt</span>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
